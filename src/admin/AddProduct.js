...
const AddProduct = () => {
  ...
  const newPostForm = () => (
    <form className="container max-w-sm mx-auto md:max-w-2xl xl:max-w-3xl h-full flex-col bg-white rounded-lg shadow overflow-hidden justify-between mx-4" onSubmit={clickSubmit}>
