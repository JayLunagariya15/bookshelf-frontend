...
const UserDashboard = () => {
  ...
  const userLinks = () => {
    return (
      <div className="mb-5 border rounded-lg h-fit w-full max-w-xs lg:max-w-sm overflow-hidden shadow-xl">
        <h4 className="bg-black w-full text-white text-center py-3 rounded-t">
          User Links
        </h4>
  ...
  const userInfo = () => {
    return (
      <div className="">
        {" "}
        <div className=" mb-5 border w-full overflow-hidden shadow-lg">
          <h3 className="bg-black text-white py-2 text-center rounded-t">
            User Information
          </h3>
  ...
  return (
    ...
    >
      <div className="row">
        <div className="flex flex-col sm:flex sm:flex-row justify-between sm:gap-10 mb-40 mx-4">
          {userLinks()}
          {userInfo()}
        </div>

        <div className="xs-col-12 col-sm-8 mx-4">{purchaseHistory(history)}</div>
      </div>
    </Layout>
  );
};
