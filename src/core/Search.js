...
const Search = () => {
  ...
  const searchedProducts = (results = []) => {
    return (
      <div className="mx-4">
        <h2 className="mt-4 mb-4 text-lg font-medium text-red-600 ">
  ...
  const searchForm = () => (
    <form onSubmit={searchSubmit}>
      <div className="flex justify-center md:py-5 ">
        <div className="flex-col items-center flex sm:justify-between sm:flex-row gap-4 w-full sm:flex sm:w-full lg:max-w-xl ">
          <div className="">
            <select
          ...
          <input
            type="search"
            className="text-sm bg-gray-200 appearance-none rounded w-72 sm:w-96 max-w-2xl py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline h-10"
